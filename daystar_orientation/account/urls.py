...
from .views import AccountList, AccountDetail, CustomAuthToken, FirstTimeUserPasswordChangeView, Contacts, StatsView, StatsData, DocumentUploadView, DocumentListView, DocumentDetailView, login_view, dashboard_view, studentsadd_view, studentedit_view, studentsdetails_view, logout_view, G9_view
...
urlpatterns = [
    ...
    path('dashboard/', dashboard_view, name='dashboard'),
     path('students/edit/', studentedit_view, name='students_edit'),
